...
\hypertarget{ux4e00ux9ad8ux9636ux601dux7ef4ux4e0eux95eeux9898ux89e3ux51b3ux80fdux529b}{%
\subsection{一、高阶思维与问题解决能力}\label{ux4e00ux9ad8ux9636ux601dux7ef4ux4e0eux95eeux9898ux89e3ux51b3ux80fdux529b}}
...
\subsubsection{1. 问题分解与抽象建模能力}\label{ux95eeux9898ux5206ux89e3ux4e0eux62bdux8c61ux5efaux6a21ux80fdux529b}}
...
\subsubsection{2. 算法与数据结构思维}\label{ux7b97ux6cd5ux4e0eux6570ux636eux7ed3ux6784ux601dux7ef4}}
...
\subsubsection{3. 数据分析流程设计与规划能力}\label{ux6570ux636eux5206ux6790ux6d41ux7a0bux8bbeux8ba1ux4e0eux89c4ux5212ux80fdux529b}}
...
\hypertarget{ux4e8cux4e0ellmux534fux540cux5de5ux4f5cux7684ux80fdux529b}{%
\subsection{二、与LLM协同工作的能力}\label{ux4e8cux4e0ellmux534fux540cux5de5ux4f5cux7684ux80fdux529b}}
...
\subsubsection{1. 精确提问与Prompt工程能力}\label{ux7cbeux786eux63d0ux95eeux4e0epromptux5de5ux7a0bux80fdux529b}}
...
\textbf{生态学案例}：在研究森林群落构建机制时，精确的提问能力显得尤为重要。假设你要分析环境过滤和生物相互作用对物种共现模式的影响，一个模糊的提问可能是：``帮我分析物种共现模式''。而精确的提问应该包括：明确分析目标------``使用零模型分析检验天目山20个样地中木本植物的物种共现模式，检验环境过滤和竞争排斥的相对重要性''；数据约束------``数据包含每个样地的物种多度矩阵和环境因子（海拔、坡度、土壤pH值），需要排除DBH\textless1cm的个体''；方法要求------``使用vegan包计算C-score和Checkerboard指数，采用固定行列和固定物种丰富度的零模型，进行999次随机化，输出统计显著性和效应大小''；结果格式------``生成包含观察值、期望值、标准效应大小和p值的表格，以及物种对共现模式的可视化图表''。通过这种精确的提问，LLM能够生成专业、可复现的生态学分析代码，大大提高了研究效率和分析质量。

\hypertarget{ux4ee3ux7801ux5ba1ux67e5ux4e0eux6279ux5224ux6027ux9a8cux8bc1ux80fdux529b}{%
\subsubsection{2. 代码审查与批判性验证能力}\label{ux4ee3ux7801ux5ba1ux67e5ux4e0eux6279ux5224ux6027ux9a8cux8bc1ux80fdux529b}}
...
\subsubsection{3. 迭代与优化能力}\label{ux8fedux4ee3ux4e0eux4f18ux5316ux80fdux529b}}
...
\hypertarget{ux4e09ux4f20ux7edfux4f46ux6108ux53d1ux91cdux8981ux7684ux8f6fux6280ux80fd}{%
\subsection{三、传统但愈发重要的软技能}\label{ux4e09ux4f20ux7edfux4f46ux6108ux53d1ux91cdux8981ux7684ux8f6fux6280ux80fd}}
...
\subsubsection{1. 数据分析调试与问题排查能力}\label{ux6570ux636eux5206ux6790ux8c03ux8bd5ux4e0eux95eeux9898ux6392ux67e5ux80fdux529b}}
...
\subsubsection{2. 沟通与协作能力}\label{ux6c9fux901aux4e0eux534fux4f5cux80fdux529b}}
...
\subsubsection{3. 持续学习与好奇心}\label{ux6301ux7eedux5b66ux4e60ux4e0eux597dux5947ux5fc3}}
...
\hypertarget{ux7b97ux6cd5ux601dux7ef4ux57f9ux517b}{%
\subsection{算法思维培养}\label{ux7b97ux6cd5ux601dux7ef4ux57f9ux517b}}

\hypertarget{ux95eeux9898ux5206ux89e3ux4e0eux6b65ux9aa4ux5316ux601dux8003}{%
\subsubsection{问题分解与步骤化思考}\label{ux95eeux9898ux5206ux89e3ux4e0eux6b65ux9aa4ux5316ux601dux8003}}

\textbf{生态学案例}：统计森林样地中不同树种的多样性指数
...
\item
  \textbf{数据收集}：读取样地调查数据
\item
  \textbf{数据清洗}：处理缺失值和异常值
\item
  \textbf{物种计数}：统计每个物种的个体数
\item
  \textbf{多样性计算}：计算Shannon-Wiener指数、Simpson指数等
\item
  \textbf{结果可视化}：绘制多样性图表
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 示例：计算物种多样性}
\NormalTok{calculate\_diversity }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(species\_data) \{}
  \CommentTok{\# 步骤1：统计每个物种的频数}
\NormalTok{  species\_counts }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(species\_data)}

  \CommentTok{\# 步骤2：计算总个体数}
\NormalTok{  total\_individuals }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(species\_counts)}

  \CommentTok{\# 步骤3：计算每个物种的比例}
\NormalTok{  species\_proportions }\OtherTok{\textless{}{-}}\NormalTok{ species\_counts }\SpecialCharTok{/}\NormalTok{ total\_individuals}

  \CommentTok{\# 步骤4：计算Shannon多样性指数}
\NormalTok{  shannon\_index }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FunctionTok{sum}\NormalTok{(species\_proportions }\SpecialCharTok{*} \FunctionTok{log}\NormalTok{(species\_proportions))}

  \CommentTok{\# 步骤5：计算Simpson多样性指数}
\NormalTok{  simpson\_index }\OtherTok{\textless{}{-}} \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{sum}\NormalTok{(species\_proportions}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}

  \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
    \AttributeTok{shannon =}\NormalTok{ shannon\_index,}
    \AttributeTok{simpson =}\NormalTok{ simpson\_index,}
    \AttributeTok{richness =} \FunctionTok{length}\NormalTok{(species\_counts)}
\NormalTok{  ))}
\NormalTok{\}}

\CommentTok{\# 使用示例}
\NormalTok{sample\_species }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Oak"}\NormalTok{, }\StringTok{"Pine"}\NormalTok{, }\StringTok{"Oak"}\NormalTok{, }\StringTok{"Maple"}\NormalTok{, }\StringTok{"Pine"}\NormalTok{, }\StringTok{"Birch"}\NormalTok{, }\StringTok{"Oak"}\NormalTok{)}
\NormalTok{diversity\_results }\OtherTok{\textless{}{-}} \FunctionTok{calculate\_diversity}\NormalTok{(sample\_species)}
\FunctionTok{print}\NormalTok{(diversity\_results)}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux6a21ux5f0fux8bc6ux522bux4e0eux89c4ux5f8bux53d1ux73b0}{%
\subsubsection{模式识别与规律发现}\label{ux6a21ux5f0fux8bc6ux522bux4e0eux89c4ux5f8bux53d1ux73b0}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 分析温度数据的季节性模式}
\CommentTok{\# 假设我们有12个月的月平均温度数据}
\NormalTok{monthly\_temps }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FloatTok{3.2}\NormalTok{, }\FloatTok{5.1}\NormalTok{, }\FloatTok{10.3}\NormalTok{, }\FloatTok{16.8}\NormalTok{, }\FloatTok{21.5}\NormalTok{, }\FloatTok{25.3}\NormalTok{,}
                   \FloatTok{28.7}\NormalTok{, }\FloatTok{27.9}\NormalTok{, }\FloatTok{23.4}\NormalTok{, }\FloatTok{17.6}\NormalTok{, }\FloatTok{10.8}\NormalTok{, }\FloatTok{4.9}\NormalTok{)}
\NormalTok{months }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{:}\DecValTok{12}

\CommentTok{\# 识别最高温和最低温}
\NormalTok{max\_temp }\OtherTok{\textless{}{-}} \FunctionTok{max}\NormalTok{(monthly\_temps)}
\NormalTok{min\_temp }\OtherTok{\textless{}{-}} \FunctionTok{min}\NormalTok{(monthly\_temps)}
\NormalTok{max\_month }\OtherTok{\textless{}{-}} \FunctionTok{which.max}\NormalTok{(monthly\_temps)}
\NormalTok{min\_month }\OtherTok{\textless{}{-}} \FunctionTok{which.min}\NormalTok{(monthly\_temps)}

\FunctionTok{cat}\NormalTok{(}\FunctionTok{sprintf}\NormalTok{(}\StringTok{"最高温度: \%.1f°C (月份: \%d)}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, max\_temp, max\_month))}
\FunctionTok{cat}\NormalTok{(}\FunctionTok{sprintf}\NormalTok{(}\StringTok{"最低温度: \%.1f°C (月份: \%d)}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, min\_temp, min\_month))}

\CommentTok{\# 计算年平均温度}
\NormalTok{annual\_mean }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(monthly\_temps)}
\FunctionTok{cat}\NormalTok{(}\FunctionTok{sprintf}\NormalTok{(}\StringTok{"年平均温度: \%.1f°C}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{, annual\_mean))}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux7f16ux7a0bux601dux7ef4ux5b9eux8df5}{%
\subsection{编程思维实践}\label{ux7f16ux7a0bux601dux7ef4ux5b9eux8df5}}

\hypertarget{ux6a21ux5757ux5316ux601dux7ef4ux51fdux6570ux5c01ux88c5ux4e0eux5355ux4e00ux804cux8d23ux539fux5219}{%
\subsubsection{模块化思维：函数封装与单一职责原则}\label{ux6a21ux5757ux5316ux601dux7ef4ux51fdux6570ux5c01ux88c5ux4e0eux5355ux4e00ux804cux8d23ux539fux5219}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 不好的做法：一个函数做太多事情}
\NormalTok{process\_forest\_data\_bad }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data\_file) \{}
  \CommentTok{\# 读取数据、清洗数据、分析数据、画图都在一个函数里}
\NormalTok{  data }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(data\_file)}
\NormalTok{  data }\OtherTok{\textless{}{-}} \FunctionTok{na.omit}\NormalTok{(data)}
\NormalTok{  diversity }\OtherTok{\textless{}{-}} \FunctionTok{calculate\_diversity}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{species)}
  \FunctionTok{plot}\NormalTok{(diversity}\SpecialCharTok{$}\NormalTok{shannon)}
  \FunctionTok{return}\NormalTok{(diversity)}
\NormalTok{\}}

\CommentTok{\# 好的做法：每个函数只做一件事}
\NormalTok{read\_forest\_data }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(file\_path) \{}
  \CommentTok{\# 只负责读取数据}
\NormalTok{  data }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(file\_path)}
  \FunctionTok{return}\NormalTok{(data)}
\NormalTok{\}}

\NormalTok{clean\_forest\_data }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data) \{}
  \CommentTok{\# 只负责数据清洗}
\NormalTok{  data }\OtherTok{\textless{}{-}} \FunctionTok{na.omit}\NormalTok{(data)}
\NormalTok{  data }\OtherTok{\textless{}{-}}\NormalTok{ data[data}\SpecialCharTok{$}\NormalTok{dbh }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, ]  }\CommentTok{\# 去除异常值}
  \FunctionTok{return}\NormalTok{(data)}
\NormalTok{\}}

\NormalTok{analyze\_diversity }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(species\_vector) \{}
  \CommentTok{\# 只负责多样性分析}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{calculate\_diversity}\NormalTok{(species\_vector))}
\NormalTok{\}}

\CommentTok{\# 主函数协调各个模块}
\NormalTok{process\_forest\_data\_good }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data\_file) \{}
\NormalTok{  raw\_data }\OtherTok{\textless{}{-}} \FunctionTok{read\_forest\_data}\NormalTok{(data\_file)}
\NormalTok{  clean\_data }\OtherTok{\textless{}{-}} \FunctionTok{clean\_forest\_data}\NormalTok{(raw\_data)}
\NormalTok{  results }\OtherTok{\textless{}{-}} \FunctionTok{analyze\_diversity}\NormalTok{(clean\_data}\SpecialCharTok{$}\NormalTok{species)}
  \FunctionTok{return}\NormalTok{(results)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux63a5ux53e3ux8bbeux8ba1ux601dux7ef4ux6e05ux6670ux7684ux8f93ux5165ux8f93ux51faux89c4ux8303}{%
\subsubsection{接口设计思维：清晰的输入输出规范}\label{ux63a5ux53e3ux8bbeux8ba1ux601dux7ef4ux6e05ux6670ux7684ux8f93ux5165ux8f93ux51faux89c4ux8303}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 定义清晰的函数接口}
\NormalTok{calculate\_tree\_volume }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(}
\NormalTok{  dbh,           }\CommentTok{\# 胸径(cm)，数值向量}
\NormalTok{  height,        }\CommentTok{\# 树高(m)，数值向量}
  \AttributeTok{species\_type =} \StringTok{"broadleaf"}  \CommentTok{\# 树种类型，可选"broadleaf"或"conifer"}
\NormalTok{) \{}
  \CommentTok{\# 输入验证}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{length}\NormalTok{(dbh) }\SpecialCharTok{!=} \FunctionTok{length}\NormalTok{(height)) \{}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"dbh和height的长度必须相同"}\NormalTok{)}
\NormalTok{  \}}

  \ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\NormalTok{species\_type }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"broadleaf"}\NormalTok{, }\StringTok{"conifer"}\NormalTok{)) \{}
    \FunctionTok{stop}\NormalTok{(}\StringTok{"species\_type必须是\textquotesingle{}broadleaf\textquotesingle{}或\textquotesingle{}conifer\textquotesingle{}"}\NormalTok{)}
\NormalTok{  \}}

  \CommentTok{\# 根据树种类型选择不同的体积公式}
  \ControlFlowTok{if}\NormalTok{ (species\_type }\SpecialCharTok{==} \StringTok{"broadleaf"}\NormalTok{) \{}
    \CommentTok{\# 阔叶树体积公式}
\NormalTok{    volume }\OtherTok{\textless{}{-}} \FloatTok{0.00006} \SpecialCharTok{*}\NormalTok{ dbh}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ height}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
    \CommentTok{\# 针叶树体积公式}
\NormalTok{    volume }\OtherTok{\textless{}{-}} \FloatTok{0.00005} \SpecialCharTok{*}\NormalTok{ dbh}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ height}
\NormalTok{  \}}
...
\CommentTok{\# 使用示例}
\NormalTok{dbh\_values }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{25}\NormalTok{, }\DecValTok{30}\NormalTok{, }\DecValTok{35}\NormalTok{, }\DecValTok{40}\NormalTok{)}
\NormalTok{height\_values }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{15}\NormalTok{, }\DecValTok{18}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{22}\NormalTok{)}
\NormalTok{volumes }\OtherTok{\textless{}{-}} \FunctionTok{calculate\_tree\_volume}\NormalTok{(dbh\_values, height\_values, }\StringTok{"broadleaf"}\NormalTok{)}
\FunctionTok{print}\NormalTok{(volumes)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ux6a21ux5757ux4e09rux8bedux8a00ux95eeux9898ux89e3ux51b3ux5b9eux8df5}{%
\section{模块三：R语言问题解决实践}\label{ux6a21ux5757ux4e09rux8bedux8a00ux95eeux9898ux89e3ux51b3ux5b9eux8df5}}

\hypertarget{ux6570ux636eux5904ux7406ux57faux7840}{%
\subsection{数据处理基础}\label{ux6570ux636eux5904ux7406ux57faux7840}}

\hypertarget{ux6570ux636eux5bfcux5165ux4e0eux5bfcux51fa}{%
\subsubsection{数据导入与导出}\label{ux6570ux636eux5bfcux5165ux4e0eux5bfcux51fa}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 读取CSV文件}
\NormalTok{forest\_data }\OtherTok{\textless{}{-}} \FunctionTok{read.csv}\NormalTok{(}\StringTok{"data/forest\_survey.csv"}\NormalTok{)}

\CommentTok{\# 读取Excel文件}
\FunctionTok{library}\NormalTok{(readxl)}
\NormalTok{forest\_data }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"data/forest\_survey.xlsx"}\NormalTok{)}

\CommentTok{\# 保存处理后的数据}
\FunctionTok{write.csv}\NormalTok{(cleaned\_data, }\StringTok{"output/cleaned\_forest\_data.csv"}\NormalTok{, }\AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{)}

\CommentTok{\# 使用tidyverse更优雅的数据处理}
\FunctionTok{library}\NormalTok{(tidyverse)}

\NormalTok{forest\_data }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"data/forest\_survey.csv"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{dbh\_category =} \FunctionTok{case\_when}\NormalTok{(}
\NormalTok{    dbh }\SpecialCharTok{\textless{}} \DecValTok{10} \SpecialCharTok{\textasciitilde{}} \StringTok{"sapling"}\NormalTok{,}
\NormalTok{    dbh }\SpecialCharTok{\textless{}} \DecValTok{30} \SpecialCharTok{\textasciitilde{}} \StringTok{"medium"}\NormalTok{,}
    \ConstantTok{TRUE} \SpecialCharTok{\textasciitilde{}} \StringTok{"large"}
\NormalTok{  ))}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux6570ux636eux6e05ux6d17ux4e0eux9884ux5904ux7406}{%
\subsubsection{数据清洗与预处理}\label{ux6570ux636eux6e05ux6d17ux4e0eux9884ux5904ux7406}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 数据质量检查函数}
\NormalTok{check\_data\_quality }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data) \{}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"数据基本信息:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"行数:"}\NormalTok{, }\FunctionTok{nrow}\NormalTok{(data), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"列数:"}\NormalTok{, }\FunctionTok{ncol}\NormalTok{(data), }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"缺失值数量:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \FunctionTok{print}\NormalTok{(}\FunctionTok{colSums}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(data)))}

  \CommentTok{\# 检查数值列的统计信息}
\NormalTok{  numeric\_cols }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(data, is.numeric)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{any}\NormalTok{(numeric\_cols)) \{}
    \FunctionTok{cat}\NormalTok{(}\StringTok{"数值列统计信息:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
    \FunctionTok{print}\NormalTok{(}\FunctionTok{summary}\NormalTok{(data[, numeric\_cols]))}
\NormalTok{  \}}
\NormalTok{\}}

\CommentTok{\# 数据清洗函数}
\NormalTok{clean\_forest\_data }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data) \{}
\NormalTok{  cleaned }\OtherTok{\textless{}{-}}\NormalTok{ data }\SpecialCharTok{\%\textgreater{}\%}
    \CommentTok{\# 去除完全空白的行}
    \FunctionTok{filter}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(species) }\SpecialCharTok{|} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(dbh) }\SpecialCharTok{|} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(height)) }\SpecialCharTok{\%\textgreater{}\%}

    \CommentTok{\# 处理缺失值}
    \FunctionTok{mutate}\NormalTok{(}
      \AttributeTok{dbh =} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(dbh), }\FunctionTok{median}\NormalTok{(dbh, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{), dbh),}
      \AttributeTok{height =} \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(height), }\FunctionTok{median}\NormalTok{(height, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{), height)}
\NormalTok{    ) }\SpecialCharTok{\%\textgreater{}\%}

    \CommentTok{\# 去除异常值（DBH为负值或极大值）}
    \FunctionTok{filter}\NormalTok{(dbh }\SpecialCharTok{\textgreater{}} \DecValTok{0} \SpecialCharTok{\&}\NormalTok{ dbh }\SpecialCharTok{\textless{}} \DecValTok{300}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
...
\hypertarget{ux7edfux8ba1ux5206ux6790ux5e94ux7528}{%
\subsection{统计分析应用}\label{ux7edfux8ba1ux5206ux6790ux5e94ux7528}}

\hypertarget{ux63cfux8ff0ux6027ux7edfux8ba1ux5206ux6790}{%
\subsubsection{描述性统计分析}\label{ux63cfux8ff0ux6027ux7edfux8ba1ux5206ux6790}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 生态学数据的描述性统计}
\NormalTok{descriptive\_stats }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data) \{}
\NormalTok{  stats }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}

  \CommentTok{\# 数值变量的统计}
  \ControlFlowTok{if}\NormalTok{ (}\StringTok{"dbh"} \SpecialCharTok{\%in\%} \FunctionTok{names}\NormalTok{(data)) \{}
\NormalTok{    stats}\SpecialCharTok{$}\NormalTok{dbh }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean =} \FunctionTok{mean}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{dbh, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
      \AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{dbh, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
      \AttributeTok{min =} \FunctionTok{min}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{dbh, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
      \AttributeTok{max =} \FunctionTok{max}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{dbh, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
      \AttributeTok{median =} \FunctionTok{median}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{dbh, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{    )}
\NormalTok{  \}}

  \CommentTok{\# 分类变量的统计}
  \ControlFlowTok{if}\NormalTok{ (}\StringTok{"species"} \SpecialCharTok{\%in\%} \FunctionTok{names}\NormalTok{(data)) \{}
\NormalTok{    stats}\SpecialCharTok{$}\NormalTok{species\_richness }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(}\FunctionTok{unique}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{species))}
\NormalTok{    stats}\SpecialCharTok{$}\NormalTok{species\_counts }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{species)}
\NormalTok{  \}}
...
\CommentTok{\# 使用示例}
\NormalTok{stats }\OtherTok{\textless{}{-}} \FunctionTok{descriptive\_stats}\NormalTok{(forest\_data)}
\FunctionTok{print}\NormalTok{(stats)}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux63a8ux8bbaux7edfux8ba1ux65b9ux6cd5}{%
\subsubsection{推论统计方法}\label{ux63a8ux8bbaux7edfux8ba1ux65b9ux6cd5}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# t检验示例：比较两个样地的平均胸径}
\CommentTok{\# 假设我们有两个样地的数据}
\NormalTok{plot1\_dbh }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FloatTok{15.3}\NormalTok{, }\FloatTok{18.7}\NormalTok{, }\FloatTok{22.1}\NormalTok{, }\FloatTok{19.4}\NormalTok{, }\FloatTok{16.8}\NormalTok{)}
\NormalTok{plot2\_dbh }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FloatTok{12.9}\NormalTok{, }\FloatTok{14.2}\NormalTok{, }\FloatTok{11.7}\NormalTok{, }\FloatTok{13.5}\NormalTok{, }\FloatTok{15.1}\NormalTok{)}

\CommentTok{\# 执行t检验}
\NormalTok{t\_test\_result }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(plot1\_dbh, plot2\_dbh)}
\FunctionTok{print}\NormalTok{(t\_test\_result)}

\CommentTok{\# 方差分析示例：比较多个样地的多样性}
\FunctionTok{library}\NormalTok{(dplyr)}
\FunctionTok{library}\NormalTok{(vegan)}

\CommentTok{\# 计算每个样地的Shannon指数}
\NormalTok{sample\_data }\OtherTok{\textless{}{-}}\NormalTok{ forest\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(plot\_id) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarise}\NormalTok{(}
    \AttributeTok{shannon =} \FunctionTok{diversity}\NormalTok{(}\FunctionTok{table}\NormalTok{(species), }\AttributeTok{index =} \StringTok{"shannon"}\NormalTok{)}
\NormalTok{  )}

\CommentTok{\# 假设我们有样地类型信息（如：原始林、次生林、人工林）}
\CommentTok{\# 执行方差分析}
\CommentTok{\# aov\_result \textless{}{-} aov(shannon \textasciitilde{} forest\_type, data = sample\_data)}
\CommentTok{\# summary(aov\_result)}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux53efux89c6ux5316ux7f16ux7a0b}{%
\subsection{可视化编程}\label{ux53efux89c6ux5316ux7f16ux7a0b}}

\hypertarget{ggplot2ux56feux5f62ux8bedux6cd5}{%
\subsubsection{ggplot2图形语法}\label{ggplot2ux56feux5f62ux8bedux6cd5}}
...
\CommentTok{\# 创建生态学数据可视化}
\CommentTok{\# 1. 物种分布直方图}
\NormalTok{species\_histogram }\OtherTok{\textless{}{-}}\NormalTok{ forest\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dbh, }\AttributeTok{fill =}\NormalTok{ species)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\AttributeTok{binwidth =} \DecValTok{5}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"不同物种的胸径分布"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"胸径 (cm)"}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"个体数"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}

\FunctionTok{print}\NormalTok{(species\_histogram)}

\CommentTok{\# 2. 样地多样性比较}
\NormalTok{plot\_diversity }\OtherTok{\textless{}{-}}\NormalTok{ sample\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{factor}\NormalTok{(plot\_id), }\AttributeTok{y =}\NormalTok{ shannon)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"各样地Shannon多样性指数比较"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"样地编号"}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"Shannon多样性指数"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text.x =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{angle =} \DecValTok{45}\NormalTok{, }\AttributeTok{hjust =} \DecValTok{1}\NormalTok{))}

\FunctionTok{print}\NormalTok{(plot\_diversity)}

\CommentTok{\# 3. 散点图：胸径与树高的关系}
\NormalTok{scatter\_plot }\OtherTok{\textless{}{-}}\NormalTok{ forest\_data }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dbh, }\AttributeTok{y =}\NormalTok{ height, }\AttributeTok{color =}\NormalTok{ species)) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"胸径与树高的关系"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"胸径 (cm)"}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"树高 (m)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{()}
...
\hypertarget{ux6a21ux5757ux56dbux7efcux5408ux5b9eux8df5ux9879ux76ee}{%
\section{模块四：综合实践项目}\label{ux6a21ux5757ux56dbux7efcux5408ux5b9eux8df5ux9879ux76ee}}

\hypertarget{ux9879ux76eeux4e00ux68eeux6797ux751fux6001ux7cfbux7edfux6570ux636eux5206ux6790ux6d41ux7a0b}{%
\subsection{项目一：森林生态系统数据分析流程}\label{ux9879ux76eeux4e00ux68eeux6797ux751fux6001ux7cfbux7edfux6570ux636eux5206ux6790ux6d41ux7a0b}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 完整的森林数据分析项目}
\NormalTok{analyze\_forest\_ecosystem }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data\_file, }\AttributeTok{output\_dir =} \StringTok{"output"}\NormalTok{) \{}
...
\NormalTok{  \}}
  ...
  \CommentTok{\# 1. 数据读取与验证}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"步骤1: 读取数据...}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{  raw\_data }\OtherTok{\textless{}{-}} \FunctionTok{read\_forest\_data}\NormalTok{(data\_file)}

  \CommentTok{\# 2. 数据质量检查}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"步骤2: 检查数据质量...}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \FunctionTok{check\_data\_quality}\NormalTok{(raw\_data)}

  \CommentTok{\# 3. 数据清洗}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"步骤3: 数据清洗...}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{  clean\_data }\OtherTok{\textless{}{-}} \FunctionTok{clean\_forest\_data}\NormalTok{(raw\_data)}

  \CommentTok{\# 4. 多样性分析}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"步骤4: 计算多样性指数...}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{  diversity\_by\_plot }\OtherTok{\textless{}{-}}\NormalTok{ clean\_data }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{group\_by}\NormalTok{(plot\_id) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{summarise}\NormalTok{(}
      \AttributeTok{species\_richness =} \FunctionTok{n\_distinct}\NormalTok{(species),}
      \AttributeTok{shannon\_index =} \FunctionTok{diversity}\NormalTok{(}\FunctionTok{table}\NormalTok{(species), }\AttributeTok{index =} \StringTok{"shannon"}\NormalTok{),}
      \AttributeTok{simpson\_index =} \FunctionTok{diversity}\NormalTok{(}\FunctionTok{table}\NormalTok{(species), }\AttributeTok{index =} \StringTok{"simpson"}\NormalTok{)}
\NormalTok{    )}

  \CommentTok{\# 5. 统计分析}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"步骤5: 执行统计分析...}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \CommentTok{\# 这里可以添加各种统计检验}

  \CommentTok{\# 6. 生成报告}
  \FunctionTok{cat}\NormalTok{(}\StringTok{"步骤6: 生成分析报告...}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
  \FunctionTok{generate\_forest\_report}\NormalTok{(clean\_data, diversity\_by\_plot, output\_dir)}

  \FunctionTok{cat}\NormalTok{(}\StringTok{"分析完成！结果保存在"}\NormalTok{, output\_dir, }\StringTok{"目录中}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}

  \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
    \AttributeTok{clean\_data =}\NormalTok{ clean\_data,}
    \AttributeTok{diversity\_results =}\NormalTok{ diversity\_by\_plot}
\NormalTok{  ))}
\NormalTok{\}}

\CommentTok{\# 生成分析报告的函数}
\NormalTok{generate\_forest\_report }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(data, diversity\_results, output\_dir) \{}

  \CommentTok{\# 创建HTML报告}
\NormalTok{  rmarkdown}\SpecialCharTok{::}\FunctionTok{render}\NormalTok{(}
    \AttributeTok{input =} \StringTok{"templates/forest\_report.Rmd"}\NormalTok{,}
    \AttributeTok{output\_file =} \FunctionTok{file.path}\NormalTok{(output\_dir, }\StringTok{"forest\_analysis\_report.html"}\NormalTok{),}
    \AttributeTok{params =} \FunctionTok{list}\NormalTok{(}
      \AttributeTok{data =}\NormalTok{ data,}
      \AttributeTok{diversity\_results =}\NormalTok{ diversity\_results}
\NormalTok{    )}
\NormalTok{  )}

  \CommentTok{\# 保存关键结果到CSV}
  \FunctionTok{write.csv}\NormalTok{(diversity\_results,}
            \FunctionTok{file.path}\NormalTok{(output\_dir, }\StringTok{"diversity\_results.csv"}\NormalTok{),}
            \AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{)}

  \CommentTok{\# 生成摘要统计}
\NormalTok{  summary\_stats }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
    \AttributeTok{total\_plots =} \FunctionTok{nrow}\NormalTok{(diversity\_results),}
    \AttributeTok{total\_species =} \FunctionTok{length}\NormalTok{(}\FunctionTok{unique}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{species)),}
    \AttributeTok{total\_individuals =} \FunctionTok{nrow}\NormalTok{(data),}
    \AttributeTok{mean\_richness =} \FunctionTok{mean}\NormalTok{(diversity\_results}\SpecialCharTok{$}\NormalTok{species\_richness),}
    \AttributeTok{mean\_shannon =} \FunctionTok{mean}\NormalTok{(diversity\_results}\SpecialCharTok{$}\NormalTok{shannon\_index)}
\NormalTok{  )}

  \FunctionTok{write.csv}\NormalTok{(summary\_stats,}
            \FunctionTok{file.path}\NormalTok{(output\_dir, }\StringTok{"summary\_statistics.csv"}\NormalTok{),}
            \AttributeTok{row.names =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\hypertarget{ux9879ux76eeux4e8cux4ea4ux4e92ux5f0fux751fux6001ux6570ux636eux53efux89c6ux5316ux4eeaux8868ux677f}{%
\subsection{项目二：交互式生态数据可视化仪表板}\label{ux9879ux76eeux4e8cux4ea4ux4e92ux5f0fux751fux6001ux6570ux636eux53efux89c6ux5316ux4eeaux8868ux677f}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 使用Shiny创建交互式仪表板（概念代码）}
\CommentTok{\# 实际使用时需要创建单独的app.R文件}
...
\NormalTok{ui }\OtherTok{\textless{}{-}} \FunctionTok{fluidPage}\NormalTok{(}
  \FunctionTok{titlePanel}\NormalTok{(}\StringTok{"森林生态系统数据分析交互界面"}\NormalTok{),}

  \FunctionTok{sidebarLayout}\NormalTok{(}
    \FunctionTok{sidebarPanel}\NormalTok{(}
      \FunctionTok{selectInput}\NormalTok{(}\StringTok{"plot\_select"}\NormalTok{, }\StringTok{"选择样地:"}\NormalTok{,}
                  \AttributeTok{choices =} \FunctionTok{unique}\NormalTok{(forest\_data}\SpecialCharTok{$}\NormalTok{plot\_id)),}
      \FunctionTok{selectInput}\NormalTok{(}\StringTok{"variable\_x"}\NormalTok{, }\StringTok{"X轴变量:"}\NormalTok{,}
                  \AttributeTok{choices =} \FunctionTok{c}\NormalTok{(}\StringTok{"dbh"}\NormalTok{, }\StringTok{"height"}\NormalTok{, }\StringTok{"species"}\NormalTok{)),}
      \FunctionTok{selectInput}\NormalTok{(}\StringTok{"variable\_y"}\NormalTok{, }\StringTok{"Y轴变量:"}\NormalTok{,}
                  \AttributeTok{choices =} \FunctionTok{c}\NormalTok{(}\StringTok{"height"}\NormalTok{, }\StringTok{"dbh"}\NormalTok{)),}
      \FunctionTok{actionButton}\NormalTok{(}\StringTok{"update\_plot"}\NormalTok{, }\StringTok{"更新图表"}\NormalTok{)}
\NormalTok{    ),}

    \FunctionTok{mainPanel}\NormalTok{(}
      \FunctionTok{plotOutput}\NormalTok{(}\StringTok{"species\_plot"}\NormalTok{),}
      \FunctionTok{plotOutput}\NormalTok{(}\StringTok{"diversity\_plot"}\NormalTok{),}
...
\NormalTok{    forest\_data }\SpecialCharTok{\%\textgreater{}\%}
      \FunctionTok{filter}\NormalTok{(plot\_id }\SpecialCharTok{==}\NormalTok{ input}\SpecialCharTok{$}\NormalTok{plot\_select)}
\NormalTok{  \})}

  \CommentTok{\# 物种分布图}
\NormalTok{  output}\SpecialCharTok{$}\NormalTok{species\_plot }\OtherTok{\textless{}{-}} \FunctionTok{renderPlot}\NormalTok{(\{}
\NormalTok{    data }\OtherTok{\textless{}{-}} \FunctionTok{filtered\_data}\NormalTok{()}

    \FunctionTok{ggplot}\NormalTok{(data, }\FunctionTok{aes\_string}\NormalTok{(}\AttributeTok{x =}\NormalTok{ input}\SpecialCharTok{$}\NormalTok{variable\_x, }\AttributeTok{y =}\NormalTok{ input}\SpecialCharTok{$}\NormalTok{variable\_y)) }\SpecialCharTok{+}
      \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ species), }\AttributeTok{size =} \DecValTok{3}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+}
      \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \FunctionTok{paste}\NormalTok{(}\StringTok{"样地"}\NormalTok{, input}\SpecialCharTok{$}\NormalTok{plot\_select, }\StringTok{"物种分布"}\NormalTok{)) }\SpecialCharTok{+}
      \FunctionTok{theme\_minimal}\NormalTok{()}
\NormalTok{  \})}

  \CommentTok{\# 多样性图表}
\NormalTok{  output}\SpecialCharTok{$}\NormalTok{diversity\_plot }\OtherTok{\textless{}{-}} \FunctionTok{renderPlot}\NormalTok{(\{}
    \CommentTok{\# 计算并绘制多样性指数}
    \CommentTok{\# ...}
\NormalTok{  \})}

  \CommentTok{\# 摘要表格}
\NormalTok{  output}\SpecialCharTok{$}\NormalTok{summary\_table }\OtherTok{\textless{}{-}} \FunctionTok{renderTable}\NormalTok{(\{}
\NormalTok{    data }\OtherTok{\textless{}{-}} \FunctionTok{filtered\_data}\NormalTok{()}

\NormalTok{    data }\SpecialCharTok{\%\textgreater{}\%}
      \FunctionTok{summarise}\NormalTok{(}
        \StringTok{\textasciigrave{}}\AttributeTok{物种数}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{n\_distinct}\NormalTok{(species),}
        \StringTok{\textasciigrave{}}\AttributeTok{个体数}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{n}\NormalTok{(),}
        \StringTok{\textasciigrave{}}\AttributeTok{平均胸径}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{mean}\NormalTok{(dbh),}
        \StringTok{\textasciigrave{}}\AttributeTok{平均树高}\StringTok{\textasciigrave{}} \OtherTok{=} \FunctionTok{mean}\NormalTok{(height)}
\NormalTok{      )}
\NormalTok{  \})}
\NormalTok{\}}
...
\tightlist
\item
  \textbf{高阶思维与问题解决能力} - LLM难以替代的分析设计能力
\item
  \textbf{与LLM协同工作的能力} - 新时代的核心协作技能
\item
  \textbf{R语言问题解决实践} - 生态学数据分析的具体应用
\end{enumerate}

通过模块化的学习路径和实际项目实践，学生将掌握现代数据分析思维，能够利用AI工具高效解决生态学研究中的数据分析问题。这种''分析方案设计师 + AI指令员 + 质量保证官''的角色定位，正是AI时代生态学研究者需要具备的核心竞争力。
