...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/null-alternative-distribution-1.png" alt="零假设与备择假设分布比较：展示在零假设和备择假设下检验统计量的概率分布，以及显著性水平的临界值" width="768" />
...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/p-value-visualization-1.png" alt="p值的可视化解释：通过概率密度函数展示p值作为在零假设下观测到当前或更极端检验统计量的概率" width="768" />
...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/kruskal-wallis-visualization-1.png" alt="Kruskal-Wallis检验的可视化解释：通过箱线图展示不同污染程度区域底栖动物生物量的分布比较" width="768" />
...
```{=html}
<div class="grViz html-widget html-fill-item" id="htmlwidget-3151f62212b6699d18df" style="width:768px;height:384px;"></div>
<script type="application/json" data-for="htmlwidget-3151f62212b6699d18df">{"x":{"diagram":"digraph multiple_comparison {\n  graph [rankdir = TB]\n\n  node [shape = rectangle, style = filled, fillcolor = lightblue]\n  A [label = \"执行方差分析\n(ANOVA)\"]\n  B [label = \"检验总体差异\n是否显著?\"]\n  C [label = \"进行多重比较校正\"]\n  D [label = \"解释具体组间差异\"]\n  E [label = \"停止分析\n(无总体差异)\"]\n\n  node [shape = diamond, fillcolor = lightgreen]\n  F [label = \"选择校正方法\n- Tukey HSD\\n- Bonferroni\\n- FDR控制\"]\n\n  A -> B\n  B -> C [label = \"是\"]\n  B -> E [label = \"否\"]\n  C -> F\n  F -> D\n}","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```

<p class="caption">(\#fig:multiple-comparison-flowchart)多重比较分析流程图：展示从方差分析到多重比较校正的完整统计分析流程</p>
</div>
...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/multiple-comparison-example-1.png" alt="多重比较校正实例分析：展示不同森林类型鸟类物种丰富度的多重比较结果及其可视化" width="960" />
<p class="caption">(\#fig:multiple-comparison-example)多重比较校正实例分析：展示不同森林类型鸟类物种丰富度的多重比较结果及其可视化</p>
</div>
...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/multiple-comparison-visualization-1.png" alt="多重比较校正效果的可视化：比较未校正、Bonferroni校正和FDR控制三种方法对p值的影响" width="960" />
...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/power-curve-plotting-1.png" alt="样本量对统计功效的影响：展示在中等效应大小下样本量增加如何提高统计功效" width="768" />
...
<div class="figure">
<img src="06-hypothesis_test_part1_files/figure-html/sensitivity-analysis-1.png" alt="效应大小对所需样本量的影响：展示不同效应大小水平下达到期望统计功效所需的样本量" width="768" />
<p class="caption">(\#fig:sensitivity-analysis)效应大小对所需样本量的影响：展示不同效应大小水平下达到期望统计功效所需的样本量</p>
</div>
