...
<embed src="08-simple_linear_regressions_files/figure-html/forest-survey-plot-1.pdf" title="温度与植物生长速率的散点图及线性回归拟合线。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/r2-comparison-plot-1.pdf" title="不同R²值的拟合效果对比：左(R²=0.1)弱、中(R²=0.5)中等、右(R²=0.9)强。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/residual-vs-fitted-plot-1.pdf" title="残差 vs 拟合值图：用于检查线性性和同方差性假设。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/qq-plot-1.pdf" title="正态Q-Q图：用于检查残差的正态性假设。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/scale-location-plot-1.pdf" title="尺度-位置图：用于检查同方差性假设。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/residual-leverage-plot-1.pdf" title="残差 vs 杠杆图：用于识别异常值和有影响的观测点。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/pairs-plot-1.pdf" title="物种丰富度与主要环境因子的散点图矩阵，展示各变量间的两两关系，用于初步探索相关性和分布特征。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/forest-model-diagnostics-1.pdf" title="森林生态系统模型的回归诊断图。包括残差vs拟合值图、正态Q-Q图、尺度-位置图和残差vs杠杆图，用于全面评估模型假设的满足情况。" width="80%" type="application/pdf" />
...
<div class="figure" style="text-align: center">
<embed src="08-simple_linear_regressions_files/figure-html/poly-regression-comparison-1.pdf" title="物种丰富度与海拔关系的多项式回归：线性与二次多项式的拟合对比。" width="80%" type="application/pdf" />
