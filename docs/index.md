...
**全书围绕一个统一的生态学研究案例展开**：林小雨是华东师范大学生态学专业的硕士研究生，她的研究课题是天童山森林动态监测样地中树木的生长、死亡与更新规律。从第一章开始，你将跟随林小雨的科研历程——从她在R语言和AI编程工具的帮助下读取天童山样地数据开始，到用概率分布描述森林中的随机性，到估计总体物种丰富度和生物量，到检验台风干扰对树木死亡率的显著影响，到建立树木生长的回归模型，最后到用机器学习和深度学习方法发现森林中隐藏的复杂模式。每一章的统计概念都从林小雨面临的具体生态学问题出发，每一章的练习都累积为一份完整的研究报告。这种"学徒式"的案例设计让你不是孤立地学习统计方法，而是在一个完整的科研叙事中自然地掌握从数据到结论的全过程。
