...
% AI协作面板 - 对应HTML中的.ai-box样式
\usepackage{xcolor}
\usepackage{framed}
\definecolor{ai-box-bg}{HTML}{F0F4FA}
\definecolor{ai-box-border}{HTML}{5B9BD5}
\newenvironment{ai-box}{%
  \def\FrameCommand{{\color{ai-box-border}\vrule width 4pt}\hspace{10pt}}%
