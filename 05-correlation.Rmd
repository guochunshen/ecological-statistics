...
系统发育相关性分析是进化生态学和比较生物学中的重要工具，用于研究物种间性状相关性时考虑其系统发育关系。由于物种共享进化历史，亲缘关系较近的物种在性状值上表现出的相似性，因此性状值间往往存在非独立性，这种非独立性可能导致传统统计方法的偏差。通过整合系统发育信息，系统发育相关性分析能够区分性状间的生态关系和进化保守性，从而更准确地揭示性状的生态和进化意义。
